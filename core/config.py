...
NOVOS_KITS_IMPALA_RANK_N = int(os.getenv("NOVOS_KITS_IMPALA_RANK_N", "8"))
NOVOS_KITS_IMPALA_RANK_COOLDOWN_SEG = int(
    os.getenv("NOVOS_KITS_IMPALA_RANK_COOLDOWN_SEG", "21600")
)
...
# WhatsApp Cloud (Meta) 1:1 opcional. Criativo no grupo = postagem manual (sem Evolution).
# Venda nova = Telegram do gestor.
WHATSAPP_API_TYPE = os.getenv("WHATSAPP_API_TYPE", "meta")  # só "meta"; evolution é ignorado
...
# Sem escopo advertising no DevCenter: não chama a API PADS (evita 404/alerta semanal).
ML_ADS_PRODUCT_ADS_FORA = os.getenv("ML_ADS_PRODUCT_ADS_FORA", "false").lower() in {
    "1",
    "true",
    "yes",
}
