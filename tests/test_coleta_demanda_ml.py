...
class ColetaDemandaMlTests(unittest.TestCase):
    ...
    def test_formatar_secoes(self):
        funil = {
            ...
            "itens": [{"titulo": "Meu PETG", "visitas_7d": 10, "unidades_pedidos": 1, "conversao_pct": 10.0}],
        }
        pc = cd.montar_pontos_cegos(consolidado={"anuncios_com_visitas": 1}, funil=funil, visitas_enriquecidas=1)
