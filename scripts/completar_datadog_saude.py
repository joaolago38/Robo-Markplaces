    ...
    return {
        ...
        "definition": {
            ...
            "widgets": [
                ...
                {
                    **_qv(
                        "API ML listou anúncios (0/1)",
                        "avg:robo.ml.saude.dados_api_ok{*}",
                        aggregator="last",
                        green_gt=0,
                        red_lt=1,
                        precision=0,
                    ),
                    "layout": {"height": 2, "width": 3, "x": 6, "y": 13},
                    "id": 780032,
                },
                {
                    **_qv(
                        "Frente Impala com MLB (0/1)",
                        "avg:robo.catalogo.frente_publicada{*}",
                        aggregator="last",
                        green_gt=0,
                        precision=0,
                    ),
                    "layout": {"height": 2, "width": 3, "x": 9, "y": 13},
                    "id": 780033,
                },
            ],
        },
